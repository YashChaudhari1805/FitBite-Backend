...
const registerUser = asyncHandler(async (req, res) => {
  ...
  if (
    [userName, email, password, goal].some((f) => f?.trim() === '') ||
    [age, height, weight].some((n) => n === undefined || n === null)
  ) {
...
const updateProfile = asyncHandler(async (req, res) => {
  ...
  if (goal && !validGoals.includes(goal)) throw new apiError(400, 'Invalid goal value')
